...
// Lottie animation URL - will be fetched dynamically
const LOTTIE_URL = "https://lottie.host/77b55ba5-567d-4201-8d05-cffabaa1fab3/lottie.json";
                ...
                <div className="w-full max-w-[600px] text-center">
                    ...
                    <div className="flex justify-center mb-8">
                        <div className="w-[200px] h-[200px]">
                            <iframe
                                src="https://lottie.host/embed/77b55ba5-567d-4201-8d05-cffabaa1fab3/lottie.json"
                                className="w-full h-full border-0"
                                title="Congratulations Animation"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-2 mb-4">
                        <p className="text-[18px] font-normal text-[#1F1F1F]">
                            Your booking is confirmed
                        </p>
                        <img
                            src="/images/payment/success-check.svg"
                            alt="Confirmed"
                            className="w-5 h-5"
                        />
                    </div>
                    ...
                    {/* Description */}
                    <div className="text-[16px] text-[#707070] leading-relaxed mb-10 max-w-[500px] mx-auto space-y-1">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <button
                            onClick={() => router.push('/')}
                            className="w-full sm:w-auto min-w-[180px] h-[52px] px-8 bg-[#F5FAFF] border border-transparent hover:border-[#136BCF]/20 text-[#136BCF] rounded-[10px] font-medium text-[15px] flex items-center justify-center gap-2 transition-colors shadow-[inset_0_0_1px_rgba(0,0,0,0.12)]"
                        >
                            <Home size={18} />
                            Go to Home
                        </button>
                        <button
                            ...
                            className="w-full sm:w-auto min-w-[200px] h-[52px] px-8 bg-[#F5FAFF] border border-transparent hover:border-[#136BCF]/20 text-[#136BCF] rounded-[10px] font-medium text-[15px] flex items-center justify-center gap-2 transition-colors shadow-[inset_0_0_1px_rgba(0,0,0,0.12)]"
                        >
